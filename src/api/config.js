...
export const AUTH_API_BASE = IS_DEV
  ? "/api/auth"
  : "https://corsproxy.io/?" + encodeURIComponent("http://wannie18-002-site3.btempurl.com/api");
...
export const DATA_API_BASE = IS_DEV
  ? "/api/data"
  : "https://corsproxy.io/?" + encodeURIComponent("http://wannie18-002-site2.btempurl.com/api");
